...
labelwelcome = Label(frame, text="Random Password Generator", font=('Arial Bold', 12))
labelPass = Label(frame, text="Password")
labelLen = Label(frame, text="Length")
entryPass = Entry(frame)
generateBtn = Button(frame, text="Generate", command=generatePass)
copyBtn = Button(frame, text="Copy", command=copypass)
